...
func get_dictionary() -> Dictionary:
	var dictionary := {"VERSION": VERSION, "ID": ID, "name": name, "author": author, "BPM": BPM, "track": track, "creator": creator, "offset": offset, "song": song,
		"image": image, "video": video, "icon": icon, "song_maps": [], "song_time_sample": song_time_sample}
...
static func dictionary_to_resource(dictionary : Dictionary) -> SongResource:
	...
	song_resource.VERSION = dictionary["VERSION"]
