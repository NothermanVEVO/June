...
var current_editor_save := SideEditorSave.new()
...
func _ready() -> void:
	current_editor_save = SideEditorSave.new()
...
func open_file(path : String) -> Error:
	...
	if current_editor_save and current_editor_save is SideEditorSave and not current_editor_save.song_maps.is_empty():
		_current_file_path = path
		_is_saved = true
